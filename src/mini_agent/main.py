...
def print_banner() -> None:
    ...
    print()
    print("╔══════════════════════════════════════════╗")
    print("║        Mini Agent - Phase 3              ║")
    print("║  Sandbox: 文件读写 + Bash 执行            ║")
    print("╠══════════════════════════════════════════╣")
    print("║  命令:                                   ║")
    ...
    print("║    /quit    — 退出                       ║")
    print("║  试试:                                   ║")
    print("║    写一个 hello.py 文件，内容打印hi       ║")
    print("║    用 bash 执行 python hello.py          ║")
    print("║    帮我算一下 100/3，然后告诉我现在几点    ║")
    print("╚══════════════════════════════════════════╝")
    print()
...
def main() -> None:
    ...
    # 2. 创建 LangGraph Agent (绑定全部工具: 内置 + 沙箱)
